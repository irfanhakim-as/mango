...
COMPULSORY_SETTINGS = list(
    ...
    "SECRET_KEY, ALLOWED_HOSTS, POST_MODEL, SCHEDULER_TIMEZONE, CELERY_BROKER_URL, CELERY_RESULT_BACKEND, CELERY_TIMEZONE, ACCESS_TOKEN, API_BASE_URL, BOT_ID, DEFAULT_VISIBILITY"
    ).split(",")
)
